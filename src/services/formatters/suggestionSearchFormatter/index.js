...
export default class SuggestionSearchFormatter {
  ...
  formatLocationLevel = ({
    ...
    const province = _.map(provinces, (item: Object): Object => {
      ...
      const { location, location_level: { province } } = config.translator;
      return {
        id: province_id,
        type: TITLE,
        title: province_name,
    ...
    const city = _.map(cities, (item: Object): Object => {
      ...
      const { location, location_level: { city } } = config.translator;
      return {
        id: city_id,
        type: TITLE,
        title: city_province,
    ...
    const districts = _.map(district, (item: Object): Object => {
      ...
      const { location, location_level: { district } } = config.translator;
      return {
        id: district_id,
        type: TITLE,
        title: district_city,
